...
var AdminExampleDatasModule = (function () {
    function AdminExampleDatasModule() {
    }
    return AdminExampleDatasModule;
}());
AdminExampleDatasModule = __decorate([
    NgModule({
        imports: [
            CommonModule,
            FormsModule,
...
], AdminExampleDatasModule);
export { AdminExampleDatasModule };
//# sourceMappingURL=admin_example_datas.module.js.map